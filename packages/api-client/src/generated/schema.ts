...
export interface operations {
    ...
    accept_invitation: {
        ...
        responses: {
            /** @description Invitation accepted or safely replayed */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Invitation token is invalid or revoked */
            404: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Current user is already an organization member */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Invitation storage is unavailable */
            503: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    list_invitations: {
        ...
        requestBody?: never;
        responses: {
            /** @description Active invitations visible to the current manager */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Current role cannot view invitations */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    create_invitation: {
        ...
        responses: {
            /** @description Invitation created; the acceptance token is returned once */
            201: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Current role cannot create this invitation */
            403: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Email is already a member or has an active invitation */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Email or role is invalid */
            422: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    revoke_invitation: {
        ...
        responses: {
            ...
            /** @description Current role cannot revoke this invitation */
            403: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Active invitation is missing */
            404: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Invitation expired before revocation */
            410: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    remove_member: {
        ...
        responses: {
            ...
            /** @description Current member cannot perform this removal */
            403: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Removal would remove the last owner */
            409: {
                headers: {
                    [name: string]: unknown;
                };
